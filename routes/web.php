...
Route::group(['middleware' => 'auth'], function () {
    Route::any('/genre', [GameGenreController::class, 'index']);
    ...
    Route::any('/state', [ProjectStateController::class, 'index']);
    ...
    Route::any('/lang', [ProgrammingLangController::class, 'index']);
    ...
    Route::any('/organization', [OrganizationsController::class, 'index']);
    ...
    Route::group(['prefix' => 'engine', 'where' => ['id' => '[0-9]+']], function () {
        Route::any('', [EnginesController::class, 'index'])->name('engines');
    ...
    Route::group(['prefix' => 'game', 'where' => ['id' => '[0-9]+']], function () {
        Route::any('', [GamesController::class, 'index'])->name('games');
